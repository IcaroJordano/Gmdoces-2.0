    ...
    return(
        <div className={`fixed w-screen bg-neutral-900/50 z-30 justify-center h-screen  ${cardVisibilit?'flex':'hidden'} `} >
            <div className="w-10/12 h-4/5 my-auto relative bg-white">
                ...
                <p className="text-lg w-11/12  mt-2  mx-auto h-auto text-center font-mono">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto repudiandae molestias placeat ratione odit? Veritatis.</p>
            </div>
        </div>
    )
}