export function CardProduto({image, preco, nome}) {
    return (
        <div className="w-44 lg:w-11/12  my-5 pb-2 rounded-lg shadow-neutral-800/30 shadow-md  ">
            <img className="h-44 lg:h-96 mt-2 rounded-md w-11/12 mx-auto  " src={image} alt="" />
