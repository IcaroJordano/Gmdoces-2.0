...
export function NavBar({cardVisibilit}) {
    return(
        <nav className={`lg:hidden z-50 fixed bottom-0 w-full h-16 ${cardVisibilit?"hidden":"flex"} bg-white`} >
            ...
            <Link to={'/explorar'} className="w-1/3 h-full flex font-light flex-col text-neutral-600 items-center justify-center"><FaHeart className="text-2xl text-rose-300" ></FaHeart>Seu pedido</Link>
