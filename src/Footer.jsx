export function Footer() {
    return(
        <section className="pb-20 pl-5">
            ...
            <p className=" text-lg font-light">Siqueira Fortaleza-Ce</p>
            <p className=" text-lg font-light">CEP</p>
            <p className=" text-lg font-light">85 98568-0328</p>
            <p className=" text-lg font-light">Gmdoces@gmail.com</p>
        </section>
    )
}