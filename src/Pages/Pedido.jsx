...
export function Pedido() {
    ...
    return (
        <section className="font-serif pb-20  flex flex-col items-center">
            ...
            <p className="w-10/12 my-5 font-semibold text-gray-500">Ao clicar no botao abaixo, sera redirecionado para nosso whatsapp para finalizar seu pedido, esperamos que tenha gostado da experiencia</p>
            <a className="bg-green-300/70 w-8/12 justify-center text-xl h-16 flex items-center rounded-md" href="">Finalizar pedido <FaWhatsapp className="mx-2"></FaWhatsapp> </a>
