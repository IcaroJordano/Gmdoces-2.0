...
export function Header() {
    return (
        <div className=" text-neutral-700 items-center justify-between h-32   w-full flex">
            ...
            <img className="h-32 w-32 ml-14  flex rounded-full " src="https://media-for1-1.cdn.whatsapp.net/v/t61.24694-24/455599010_1039709134312745_965647445426224043_n.jpg?ccb=11-4&oh=01_Q5AaIGU5WSdO503dsQ_i2DRkeuv_5mNSz2DBc-15K6jTXAGm&oe=671F34A4&_nc_sid=5e03e0&_nc_cat=102" alt="" />
